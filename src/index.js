...
const defaultComponentsConfig = {
    ...
    success: ({hide, ...rest}) => <SuccessToast {...rest} onTrailingIconPress={hide} />,
    // eslint-disable-next-line react/prop-types
    danger: ({hide, ...rest}) => <ErrorToast {...rest} onTrailingIconPress={hide} />,
    // eslint-disable-next-line react/prop-types
    info: ({hide, ...rest}) => <InfoToast {...rest} onTrailingIconPress={hide} />,
    // eslint-disable-next-line react/prop-types
    warning: ({hide, ...rest}) => <WarningToast {...rest} onTrailingIconPress={hide} />,
};
...
class Toast extends Component {
    ...
    getBaseStyle(position = 'bottom', keyboardHeight) {
        const {topOffset, bottomOffset, keyboardOffset, height, animation} = this.state;
